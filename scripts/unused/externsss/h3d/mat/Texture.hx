...
@:allow(h3d) @:native("h3d.mat.Texture") extern class Texture {
	...
	**/
	...
	function uploadBitmap(bmp:hxd.BitmapData, ?mipLevel:Int, ?layer:Int):Void;
	function uploadPixels(pixels:hxd.Pixels, ?mipLevel:Int, ?layer:Int):Void;
	...
	**/
	function capturePixels(?face:Int, ?mipLevel:Int, ?region:h2d.col.IBounds):hxd.Pixels;
	/**
	...
	**/
	...
	static function fromBitmap(bmp:hxd.BitmapData):h3d.mat.Texture;
	static function fromPixels(pixels:hxd.Pixels, ?format:h3d.mat.Data.TextureFormat):h3d.mat.Texture;
	/**
